        ...
        <div class="detail">
            <div class="itemBox">
                <div class="" :model="formData">
                    ...
                    <div class="rows">
                        <span>所属行业</span>
                        <select class="oneRows" v-model="industys" multiple="multiple">
                    ...
                    <div class="rows">
                        <span>所属阶段</span>
                        <select class="oneRows" v-model="stages" multiple="multiple">
                ...
                <div>
                    ...
                    <van-popup v-model="show" position="bottom" :overlay="true">
                        <van-area :area-list="areaList" @cancel="onCancel" @confirm="onConfirm" @change="onChange"></van-area>
                    </van-popup>
                    <div class="rows">
                        <span>详细信息</span>
