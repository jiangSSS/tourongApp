  ...
  <div class="bg-fa">
    <div class="w1200 clearfix">
      ...
      <div class="w870 fll mes_card" v-loading="loading">
        ...
        <button class="moreBtn" @click="apply(mesDetailData.status,mesDetailData.id)">
          {{mesDetailData.status == 1 ? '报名参加' :'' + mesDetailData.status == 0 ? '尚未开始':'' + mesDetailData.status == 3 ? '活动结束' : ''}}
        </button>
      </div>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <button class="applyBtn" @click="showApply = false">确认报名</button>
